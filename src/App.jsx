...
const App = () => {
    ...
    const prompts = [
        ...
        { id: 73, category: 'Studying', text: 'Generate a citation for a book/article on <topic> in APA format.' },
        { id: 74, category: 'Studying', text: 'Provide an example of how to cite a website in MLA format for a paper on <subject>.' },

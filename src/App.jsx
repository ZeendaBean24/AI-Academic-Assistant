...
const App = () => {
    ...
    const prompts = [
        ...
        { id: 77, category: 'Math', text: 'Explain the <math concept> and provide an example.' },
        { id: 78, category: 'Math', text: 'List the steps to derive <formula>.' },
        ...
        { id: 102, category: 'Creativity', text: 'Generate a list of potential project ideas for <subject>.' },
